...
async def create_content(
    ...
    # 触发 Webhook
    await trigger_webhook_and_notification(db, WebhookEventType.CONTENT_CREATED, {
        "id": content.id,
        "title": content.title,
        "slug": content.slug,
...
async def update_content(
    ...
    # 触发 Webhook
    await trigger_webhook_and_notification(db, WebhookEventType.CONTENT_UPDATED, {
        "id": content.id,
        "title": content.title,
        "slug": content.slug,
        "type": content.type.value if hasattr(content.type, 'value') else content.type,
...
async def delete_content(
    ...
    # 触发 Webhook
    await trigger_webhook_and_notification(db, WebhookEventType.CONTENT_DELETED, content_data, "deleted")
