...
async function handleResetOtp(userId: number, username: string) {
  if (!confirm(`确定要重置用户 ${username} 的 2FA 吗？`)) return
      ...
      <table class="w-full">
        <thead>
          <tr class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            ...
            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">2FA</th>
          ...
          >
            ...
            <td class="px-6 py-4 text-sm">
              <div class="flex items-center gap-2">
                ...
                <span class="text-gray-300">|</span>
                <button v-if="authStore.isAdmin" @click="handleResetOtp(user.id, user.username)" class="text-orange-600 hover:text-orange-700 font-medium transition-colors">重置2FA</button>
